...
public class func_patient {
    ...
    public void initialize() {
        ...
        ObservableList<data_patients> patients = tableOfPatients.initializeTable(table_view_patient, column_patient_id, column_record_id, column_f_name, column_s_name);
