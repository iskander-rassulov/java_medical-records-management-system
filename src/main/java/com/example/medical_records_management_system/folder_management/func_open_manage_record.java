...
public class func_open_manage_record {
    public void showManageRecordMenu(AnchorPane center_pane) {
        try {
            // Загружаем view_calendar.fxml
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/medical_records_management_system/view_manage_record_menu.fxml"));
