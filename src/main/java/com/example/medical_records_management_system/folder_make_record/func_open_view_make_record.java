...
public class func_open_view_make_record {
    public void showMakeRecord(AnchorPane center_pane) {
        try {
            // Загружаем view_calendar.fxml
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/medical_records_management_system/view_make_record.fxml"));
